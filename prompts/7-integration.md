...
- 读 `.specs/ALIGNMENT.md`，确认其"下一轮基线"已覆盖到当前 HEAD；**未跑过 / 基线落后** → 先执行 `@code-kit/prompts/S-align.md`，通过后回到本阶段
- 检测出未处理的 D2（决策矛盾）/ D5（需求失配）漂移 → **禁止继续集成**，先走人工裁决或新 CHANGE
- 本 change 纯文档、无代码提交 → 可豁免，但在 UAT.md 记一行"R15.1 豁免：无代码变更"
